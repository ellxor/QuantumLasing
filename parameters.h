...
constexpr float OmegaE = 1.28f*Omega;			// excited state energy
constexpr float GCoupling = 0.9f * Omega / sqrtf(N);	// cavity-atom coupling strength
constexpr float Phi = 3*M_PIf/4;			// phase shift of microwave drive
...
constexpr int IntegrationSteps = 400'000;
